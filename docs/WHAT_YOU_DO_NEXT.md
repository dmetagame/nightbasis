...
4. **Record the video.** Follow `docs/VIDEO_SHOT_LIST.md`, replace
   `[REPO_URL]`, keep Tesla's full `z=1.235711` visible, and export at or under
   120 seconds. Upload it somewhere judges can open without requesting access.
5. **Post on X.** Copy the exact post from `docs/SUBMISSION_FINAL.md`, replace
   `[REPO_URL]`, attach the video if appropriate, publish it, and paste the X
...
6. **Submit before the safety deadline.** Open the
   ...
   URL, and submit before **2026-09-21 18:00 UTC+8**. Review the
